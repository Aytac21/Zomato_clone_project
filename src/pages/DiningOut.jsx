...
function DiningOut() {
  ...
  useEffect(() => {
    axios
      .get("http://127.0.0.1:8000/restaurants/?category=diningout")
      .then((response) => {
  ...
  const headingStyle = {
    color: pageTitle === "Dining Out" ? "red" : "black",
  };
      ...
      <nav className="delivery-nav">
        <div className="container-ay">
          <div className="delivery-img">
            <Link to={`http://localhost:8000/home/`}>
              <img
        ...
        <section className="delivery-option">
          ...
          <div>
            <img
              ...
              alt=""
            />
            <h1 style={headingStyle}>Dining Out</h1>
          </div>
          <Link to={`/nightlife`}>
            <div>
              <img
